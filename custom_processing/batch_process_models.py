...
def process_stl(stl_path, output_dir, blender_path, script_path):
    ...
    cmd = [blender_path, "--background", "--python", script_path, "--", stl_path, output_dir]
...
def main(args):
    ...
    process_args = [(stl_file, args.output_dir, args.blender_path, args.script_path) for stl_file in stl_files]

...
# Parameters
image_folder = '/home/fabi/dev/SMILify/checkpoints/20240815-155226/SMIL_09_synth'  # Replace with the path to your folder containing PNGs
frame_rate = 10  # You can adjust the frame rate
video_name = ("SMIL-fit-" + image_folder.split("/")[-1] +
              '-output_video_' + str(frame_rate) + 'fps.mp4')  # The name of the output video file

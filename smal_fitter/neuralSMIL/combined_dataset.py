...
class CombinedSMILDataset:
    ...
    def _apply_availability_mask(self, y_data: Dict[str, Any], available_labels: Dict[str, bool]) -> Dict[str, Any]:
        """
    ...
    def create_weighted_sampler(
        self, weights: List[float], train_indices: List[int], num_samples: Optional[int] = None
    ...
    def split_datasets(
        self, train_size: float = 0.85, val_size: float = 0.05, test_size: float = 0.1, seed: int = 1234
    ) -> Tuple:
        """
    ...
    def get_statistics(self) -> Dict[str, Any]:
        ...
        """
        stats = {"total_samples": len(self.combined_dataset), "num_datasets": len(self.datasets), "datasets": []}
    ...
    def print_statistics(self):
        ...
        for ds_stats in stats["datasets"]:
            ...
            print(
                f"  Samples: {ds_stats['num_samples']} ({ds_stats['num_samples'] / stats['total_samples'] * 100:.1f}%)"
            )

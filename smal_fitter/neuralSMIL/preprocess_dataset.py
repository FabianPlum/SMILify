...
Examples:
  ...
  python preprocess_dataset.py data/my_dataset optimized.h5 \\
    ...
    # Required arguments
    parser.add_argument("input_dir", help="Input dataset directory containing JSON files")
    parser.add_argument("output_path", help="Output HDF5 file path (e.g., optimized_dataset.h5)")
    ...
    parser.add_argument(
        "--min_visible_keypoints", type=int, default=5, help="Minimum number of visible keypoints required (default: 5)"
    )
    ...
    parser.add_argument("--num_workers", type=int, default=4, help="Number of parallel processing workers (default: 4)")

    # Output options
    parser.add_argument("--quiet", action="store_true", help="Suppress progress output")
    parser.add_argument("--verbose", action="store_true", help="Print detailed error messages for each failed sample")

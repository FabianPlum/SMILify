...
def main():
    ...
    parser.add_argument(
        "--results_dir", type=str, default="fit3d_results", help="Directory containing the optimization results"
    )
    parser.add_argument("--stage_name", type=str, default=None, help="Specific stage to analyze (optional)")

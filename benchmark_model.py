...
sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), "smal_fitter")))
sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), "smal_fitter", "neuralSMIL")))
...
def main():
    ...
    output_dir = os.path.join(
        os.getcwd(), f"benchmark_model_{ckpt_stem}_on_{dataset_stem}"
    )
